...
dtm <- rast("./week10/SJER2013_DTM.tif")
...
plot_centroids <- st_read("./week10/PlotCentroids/SJERPlotCentroids_Buffer.shp")
...
veg_surveys <- read.csv(("./week10/VegetationData/D17_2013_vegStr.csv")) %>% 
  group_by(plotid) %>% 
